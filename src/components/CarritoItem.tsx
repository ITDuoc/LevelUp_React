  ...
  return (
    <div className="list-group-item cardSimple d-flex justify-content-between align-items-center mb-3">
      <div className="d-flex align-items-center">
        <img
          src={item.producto.imgProducto}
          alt={item.producto.nomProducto}
          className="rounded"
          style={{
            width: 80,
            height: 80,
        ...
        />
        <div>
          <h5 className="mb-1 text-violeta">{item.producto.nomProducto}</h5>
          <p className="mb-0">Precio: ${item.producto.precioProducto.toLocaleString()}</p>
      ...
      <div className="d-flex flex-column align-items-end me-3">
        <div className="d-flex mb-2 gap-2">
          <button
            ...
            onClick={() => onActualizarCantidad(item.producto.idProducto, item.cantidad - 1)}
          >
            -
          </button>
        ...
        <button
          ...
          onClick={() => onEliminar(item.producto.idProducto)}
          title="Eliminar"
        >
